 ...
 */
public class AddTeacherPayment extends javax.swing.JFrame {
    private Page page;

    /**
     * Creates new form AddTeacherPayment
     */
    public AddTeacherPayment(Page page) {
        this.page = page;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Teacher Payment");
...
//            java.util.logging.Logger.getLogger(AddTeacherPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new AddTeacherPayment().setVisible(true);
//            }
//        });
    }
